              ...
              <div class="col-md-12">
                <div class="card ">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <h4 class="card-title">Create Agencies</h4>
                  </div>
                  <div class="container">
                    <form id="RegisterValidation" action="#" method="">
                      ...
                      <!-- Multiple Contact Details Section -->
                      <div class="card mt-5">
                        <div class="card-header">
                            ...
                            <div class="row" id="bankDetailsSection">
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bankAccountHolder" name="bank_account_holder[]">
                                    </div>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="bankIFSC" class="bmd-label-floating">IFSC Code *</label>
                                        <input type="text" class="form-control" id="bankIFSC" name="bank_ifsc[]">
                                    </div>
                                </div>
                            </div>
                        </div>
                      ...
                      <div class="card-footer text-left mt-5">
                          <button type="submit" class="btn btn-rose">Add Agent</button>
                      </div>
                  </form>
                  </div>
                  </div>
