<footer class="footer">
    <div class="container-fluid bg-light">
      <div class="copyright float-center">
        ...
        </script>, Design & Deveopled by
        <a href="https://pixelvalues.com/" target="_blank">Pixel Values, Technolabs, Nagpur</a>.
      </div>
    </div>
  </footer>
</div>
...
<script src="{{ asset('assets/buttons.github.io/buttons.js') }}"></script>
