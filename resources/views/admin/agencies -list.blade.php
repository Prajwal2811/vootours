              ...
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <div class="d-flex justify-content-between align-items-center w-100">
                    <h4 class="card-title mb-0">Agencies List</h4>
                    <a href="{{ route('admin.create-agencies') }}" target="_blank" class="btn btn-success btn-sm" id="add-admin-btn">
                      <i class="material-icons">person_add</i> Add agencies
                    </a>
                  </div>
                </div>
