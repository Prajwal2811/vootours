              ...
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <div class="d-flex justify-content-between align-items-center w-100">
                    <h4 class="card-title mb-0">Sub Agents List</h4>
                    <a href="{{ route('admin.create-sub-agents') }}" target="_blank" class="btn btn-success btn-sm" id="add-admin-btn">
                      <i class="material-icons">person_add</i> Add Sub Agent
                    </a>
                  </div>
                </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title" id="exampleModalLongTitle">Edit Sub Agents Details</h5>
